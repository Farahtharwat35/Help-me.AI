...
# Mina
def open_Anghami():
    app_path = r"C:\Users\DELL\AppData\Local\anghami\Anghami.exe"
...
def search_playlist(playlistName):
    ...
    pyautogui.click(x=450, y=560)           # Go to the "Playlists"
    time.sleep(1)

    pyautogui.click(x=1660, y=157)          # Click on Search Bar
    time.sleep(1)
    ...
    pyautogui.click(x=570, y=430)           # Select Menu
    time.sleep(1)

    pyautogui.click(x=570, y=480)           # Shuffle play
